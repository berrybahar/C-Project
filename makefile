assembler: assembler.o file_handling.o pre_assembler.o opcodes.o instructions.o
	       gcc -ansi -Wall -pedantic -g assembler.o file_handling.o pre_assembler.o opcodes.o instructions.o -o assembler -lm
